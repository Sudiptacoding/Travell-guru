...
const BookingSundarban = () => {
    ...
    const onSubmit = data => {
        ...
        setUsers(newPlace)
        users.isSignin ? navigate('/msun') : navigate('/login')
    };
    ...
    return (
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <input className='first__inp_book' defaultValue="Satkhira" {...register("origin")} />
                <label htmlFor="destination">Destination</label>
                <input className='secend__inp_book' defaultValue="Sundarbans" {...register("destination")} />
