...
import './SreemongolMoreDetles.css';

const SreemongolMoreDetles = () => {
    ...
    return (
        <div className='detles-coxsbazar'>
            ...
            <div className='map-and-room'>
                ...
                <div class="mapouter"><div class="gmap_canvas"><iframe width="735" height="652" id="gmap_canvas" src="https://maps.google.com/maps?q=Sreemangal&t=k&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://2piratebay.org"></a><a href="https://www.embedgooglemap.net"></a></div></div>
                </div>
            </div>
        </div>
    );
...
export default SreemongolMoreDetles;